  ...
  return (
    <div className="flex flex-col w-full bg-background min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-32 pb-24 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2.5 px-3 py-1.5 bg-secondary border border-border rounded-full text-muted-foreground text-xs font-bold uppercase tracking-[0.2em] mb-12 shadow-2xl shadow-indigo-500/10"
          >
          ...
          <motion.h1 
            ...
            className="text-6xl md:text-9xl font-bold text-foreground mb-10 tracking-tight leading-[0.9]"
          >
            Precision in <br />
          ...
          <motion.p 
            ...
            className="text-xl md:text-2xl text-muted-foreground font-light max-w-3xl mx-auto mb-16 leading-relaxed"
          >
          ...
          >
            <Link 
              href="/file-itr" 
              className="px-10 py-5 bg-primary text-primary-foreground text-lg font-extrabold rounded-2xl hover:translate-y-[-4px] transition-all flex items-center gap-3 shadow-2xl shadow-primary/5"
            >
              File ITR Now
            ...
            <Link 
              ...
              className="px-10 py-5 bg-secondary border border-border text-foreground text-lg font-bold rounded-2xl hover:opacity-80 transition-all shadow-xl shadow-black/5"
            >
              Explore Services
            </Link>
          </motion.div>
      ...
      <section className="px-6 lg:px-8 mb-24 overflow-hidden">
        <div className="max-w-7xl mx-auto border border-border bg-card p-1 md:p-4 lg:p-6 rounded-[2.5rem] relative">
            <div className="absolute inset-0 bg-primary/5 opacity-30 backdrop-blur-3xl" />
            <div className="relative aspect-[21/9] w-full overflow-hidden border border-border rounded-3xl shadow-2xl">
              <img 
                src="https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?q=80&w=2600&auto=format&fit=crop" 
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-background/90 via-background/20 to-transparent flex items-end p-8 md:p-12">
                 <div className="max-w-xl">
                    <p className="text-sm font-black uppercase tracking-[0.5em] text-primary/60 mb-4 italic">Strategic Oversight</p>
                    <h3 className="text-2xl md:text-5xl font-bold text-foreground tracking-tight italic">Translating Complexity into Clarity.</h3>
                 </div>
              </div>
            </div>
        </div>
      ...
      <section id="services-deep-dive" className="py-48 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-32 text-center md:text-left">
             <h2 className="text-sm font-black uppercase tracking-[0.5em] text-primary/40 mb-4">Core Frameworks</h2>
             <h3 className="text-4xl md:text-7xl font-bold text-foreground tracking-tighter">Strategic Depth.<br /><span className="text-muted-foreground italic">Scroll to Explore.</span></h3>
          </div>
          ...
          <div className="space-y-48">
            {homeServices.map((service, idx) => (
              <motion.div 
                ...
                transition={{ duration: 0.8 }}
                className={cn(
                  "p-8 md:p-16 rounded-[4rem] border border-border bg-card/50 flex flex-col md:flex-row gap-16 items-center sticky top-32 backdrop-blur-3xl shadow-2xl overflow-hidden",
                  idx % 2 === 1 ? "md:flex-row-reverse" : ""
                )}
              >
                 {/* Decorative background number */}
                 <div className="absolute -right-10 -bottom-10 text-[20rem] font-black text-foreground/[0.03] select-none pointer-events-none italic">
                    {idx + 1}
                 </div>

                 <div className="w-full md:w-1/2 space-y-8 relative z-10">
                   <div className="h-20 w-20 rounded-3xl bg-secondary border border-border flex items-center justify-center shadow-inner">
                     {service.icon}
                   </div>
                   <h4 className="text-4xl md:text-5xl font-bold text-foreground tracking-tight">{service.title}</h4>
                   <p className="text-xl text-muted-foreground font-light leading-relaxed max-w-xl">
                      {service.description}
                   </p>
                   <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {service.features.map(feature => (
                        <div key={feature} className="flex items-center gap-3 text-foreground font-medium italic">
                 ...
                 <div className="w-full md:w-1/2 aspect-square md:aspect-[4/3] rounded-[2.5rem] overflow-hidden border border-border bg-card flex items-center justify-center relative group">
                    <img 
                      src={idx === 0 ? "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?q=80&w=1200&auto=format&fit=crop" : 
                           idx === 1 ? "https://images.unsplash.com/photo-1554224155-6726b3ff858f?q=80&w=1200&auto=format&fit=crop" :
      ...
      <section id="about-scroll" className="py-40 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="mb-20 text-center md:text-left">
            <p className="text-sm font-black uppercase tracking-[0.5em] text-primary/40 mb-4">About Us</p>
            <h3 className="text-4xl md:text-7xl font-bold text-foreground tracking-tight">
          ...
          <div className="space-y-20">
            ...
            >
              <div className="rounded-[3rem] border border-border bg-card/60 p-10 md:p-14 backdrop-blur-2xl">
                <h4 className="text-2xl md:text-4xl font-bold text-foreground mb-6">Who We Are</h4>
              ...
              <div className="rounded-[3rem] border border-border bg-card/60 p-10 md:p-14 backdrop-blur-2xl">
                <h4 className="text-2xl md:text-4xl font-bold text-foreground mb-6">Leadership</h4>
            ...
            <motion.div
              ...
              className="rounded-[3rem] border border-border bg-secondary/40 p-10 md:p-14"
            >
      ...
      <section className="py-32 relative">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="bg-secondary/50 border border-border p-16 md:p-32 rounded-[3.5rem] relative overflow-hidden text-center backdrop-blur-2xl">
            <div className="absolute inset-0 bg-indigo-500/5 blur-[100px]" />
            <div className="relative z-10 max-w-4xl mx-auto">
              <h2 className="text-4xl md:text-7xl font-bold text-foreground mb-10 tracking-tight leading-none">
                Bring your business into <br /><span className="text-primary italic opacity-70">Clear Focus.</span>
              </h2>
              <p className="text-muted-foreground text-lg md:text-xl font-light mb-16 leading-relaxed">
                Join 500+ businesses who have streamlined their financial operations with Petkar Accounting & Co.
              </p>
              <Link href="/contact" className="px-12 py-6 bg-primary text-primary-foreground text-xl font-extrabold rounded-2xl hover:translate-y-[-4px] transition-all shadow-2xl shadow-primary/10 group">
...
function StatItem({ value, label, delay }: { value: string; label: string; delay: number }) {
  return (
    ...
    >
      <h3 className="text-4xl md:text-6xl font-bold text-foreground tracking-tight group-hover:text-primary/70 transition-colors">
        {value}
      </h3>
      <p className="text-xs uppercase tracking-[0.3em] font-extrabold text-muted-foreground">
        {label}
      </p>
    </motion.div>
  );
