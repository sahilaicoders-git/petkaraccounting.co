  ...
  return (
    <div className="bg-background min-h-screen pt-24 sm:pt-28 md:pt-32 pb-14 sm:pb-20 md:pb-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Hero Section */}
        <div className="max-w-4xl mb-14 sm:mb-24 md:mb-32">
          <motion.h1 
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            className="text-4xl sm:text-5xl md:text-8xl font-bold text-foreground mb-6 sm:mb-10 md:mb-12 tracking-tight leading-none"
          >
          ...
          <motion.p 
            ...
            className="text-base sm:text-xl md:text-3xl text-muted-foreground font-light leading-relaxed italic"
          >
        ...
        {/* Core Methodology */}
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-14 md:gap-24 mb-20 sm:mb-32 md:mb-48 items-center">
          <div className="space-y-8 sm:space-y-10 md:space-y-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground tracking-tight">The Petkar <br />Standard.</h2>
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground font-light leading-relaxed max-w-lg">
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-8 pt-6 sm:pt-8 border-t border-border">
              <div className="space-y-2">
                <h4 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground">10+</h4>
                <p className="text-xs uppercase tracking-[0.2em] font-extrabold text-muted-foreground">Years Experience</p>
              </div>
              <div className="space-y-2">
                <h4 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground">5k+</h4>
          ...
          <div className="relative group">
            ...
            <div className="aspect-[4/5] bg-card border border-border rounded-[1.4rem] sm:rounded-[2rem] overflow-hidden relative shadow-2xl shadow-black/5 dark:shadow-black/40">
              ...
              <div className="absolute bottom-5 sm:bottom-8 md:bottom-12 left-5 sm:left-8 md:left-12 right-5 sm:right-8 md:right-12 text-left">
                <Quote className="h-7 w-7 sm:h-8 sm:w-8 md:h-10 md:w-10 text-primary mb-3 sm:mb-4 md:mb-6 opacity-40 shadow-2xl" />
                <p className="text-base sm:text-lg md:text-xl font-bold text-foreground mb-3 sm:mb-4 italic leading-relaxed">
                  "The goal is 100% compliance so that entrepreneurs can focus 100% on their product."
                </p>
                <div className="flex flex-col">
                   <span className="text-foreground font-black text-sm sm:text-base md:text-lg">DHANRAJ DEWAJI PETKAR</span>
        ...
        {/* Leadership Section */}
        <div className="mb-20 sm:mb-32 md:mb-48">
          <h2 className="text-xs sm:text-sm font-black uppercase tracking-[0.3em] sm:tracking-[0.4em] text-primary/40 mb-10 sm:mb-16 md:mb-24 text-center">Executive Leadership</h2>
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 max-w-5xl mx-auto">
            ...
            <div className="relative group">
              ...
              <div className="bg-card/80 border border-border rounded-[1.4rem] sm:rounded-[2rem] overflow-hidden relative shadow-2xl p-5 sm:p-7 md:p-10 group-hover:border-primary/30 transition-all h-full flex flex-col backdrop-blur-xl">
               ...
               <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-foreground mb-2 tracking-tight">DHANRAJ DEWAJI PETKAR</h3>
               <span className="text-[11px] font-black uppercase tracking-[0.28em] text-muted-foreground mb-6">Chief Executive Officer</span>
               <p className="text-sm sm:text-base md:text-lg text-muted-foreground font-light leading-relaxed mb-6 sm:mb-8 italic">
            ...
            <div className="relative group">
              ...
              <div className="bg-card/80 border border-border rounded-[1.4rem] sm:rounded-[2rem] overflow-hidden relative shadow-2xl p-5 sm:p-7 md:p-10 group-hover:border-primary/30 transition-all h-full flex flex-col backdrop-blur-xl">
               ...
               <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-foreground mb-2 tracking-tight">SAHIL DHANRAJ PETKAR</h3>
        ...
        {/* Values Section */}
        <div className="mb-20 sm:mb-32 md:mb-48">
          <h2 className="text-xs sm:text-sm uppercase tracking-[0.3em] sm:tracking-[0.4em] font-black text-muted-foreground text-center mb-10 sm:mb-16 md:mb-24">Core Values & DNA</h2>
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8 md:gap-12 text-left">
            <ValueCard 
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-12">
          <div className="bg-card/40 p-6 sm:p-10 md:p-24 rounded-2xl sm:rounded-3xl border border-border hover:border-foreground/20 transition-all group overflow-hidden relative">
            ...
            <div className="bg-card/40 p-6 sm:p-10 md:p-24 rounded-2xl sm:rounded-3xl border border-border hover:border-foreground/20 transition-all group overflow-hidden relative mt-0 md:mt-0">
               <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
               <div className="h-14 w-14 bg-background border border-border rounded-xl flex items-center justify-center text-primary/70 mb-10 group-hover:shadow-2xl transition-all">
