        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-10">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-500/10 border border-indigo-500/20 rounded-full text-indigo-400 text-xs font-black uppercase tracking-widest"
            >
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute -inset-1 bg-gradient-to-br from-indigo-500/20 to-emerald-500/20 rounded-[40px] blur-2xl opacity-50" />
            
            <div className="relative bg-card/80 backdrop-blur-3xl border border-border p-8 md:p-12 rounded-[40px] shadow-2xl">
                ...
                {!isSuccess ? (
                  ...
                  >
                    <div className="space-y-2">
                       <h3 className="text-2xl font-bold text-foreground tracking-tight">Quick Filing Portal</h3>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative group">
                          <input 
                            ...
                            className="w-full bg-background/50 border border-border rounded-2xl px-6 py-4 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all"
                            value={formData.name}
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative group">
                          ...
                          <input 
                            ...
                            maxLength={10}
                            className="w-full bg-background/50 border border-border rounded-2xl pl-16 pr-6 py-4 text-foreground uppercase placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all font-mono tracking-widest"
                            value={formData.pan}
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative group">
                            ...
                            <input 
                              ...
                              className="w-full bg-background/50 border border-border rounded-2xl pl-16 pr-6 py-4 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all font-mono"
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative group">
                            ...
                            <input 
                              ...
                              className="w-full bg-background/50 border border-border rounded-2xl pl-16 pr-6 py-4 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all"
                    ...
                    <button 
                      ...
                      className="w-full py-5 bg-primary text-primary-foreground font-black rounded-[20px] shadow-2xl shadow-primary/10 hover:scale-[0.98] transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                    >
                  ...
                  >
                    <div className="h-24 w-24 bg-emerald-500/10 border border-emerald-500/20 rounded-full flex items-center justify-center text-emerald-500 mx-auto mb-10 shadow-emerald-500/10 shadow-2xl">
                        <CheckCircle2 className="h-12 w-12" />
                    </div>
                    <h3 className="text-3xl font-bold text-foreground mb-4">Request Initiated</h3>
...
function FeatureItem({ icon, text }: { icon: React.ReactNode; text: string }) {
  return (
    <div className="flex items-center gap-4 group">
       <div className="h-10 w-10 flex items-center justify-center bg-zinc-900 rounded-xl group-hover:bg-zinc-800 transition-colors">
         {icon}
       </div>
       <span className="text-lg text-zinc-400 group-hover:text-zinc-200 transition-colors font-light italic">{text}</span>
    </div>
  );
}
