      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="mb-24">
          <motion.h1 
            ...
            className="text-5xl md:text-8xl font-bold text-foreground mb-10 tracking-tight leading-none"
          >
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-start">
          ...
          {/* Contact Form */}
          <div className="lg:col-span-7 p-1 md:p-12 lg:p-16 bg-card/60 border border-border rounded-[48px] backdrop-blur-2xl shadow-2xl shadow-black/5 dark:shadow-black/40">
            <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-10">
              <div className="space-y-4">
                 ...
                 <input 
                    ...
                    required 
                    className="w-full bg-transparent border-b border-border py-4 focus:outline-none focus:border-indigo-500 transition-all text-foreground text-lg font-light placeholder:text-muted-foreground/30"
              ...
              <div className="md:col-span-2 space-y-4 pt-4">
                 ...
                 <select 
                    ...
                    onChange={handleChange}
                    className="w-full bg-transparent border-b border-border py-4 focus:outline-none focus:border-indigo-500 transition-all text-foreground text-lg font-light appearance-none select-none cursor-pointer dark:bg-zinc-950"
                  >
              ...
              <div className="md:col-span-2 space-y-4 pt-4">
                 ...
                 <textarea 
                    ...
                    onChange={handleChange}
                    rows={4} 
                    className="w-full bg-transparent border-b border-border py-4 focus:outline-none focus:border-indigo-500 transition-all text-foreground text-lg font-light placeholder:text-muted-foreground/30 resize-none"
              ...
              <div className="md:col-span-2 pt-10">
                 <button 
                    type="submit" 
                    className="group w-full py-6 bg-primary text-primary-foreground font-extrabold rounded-2xl hover:opacity-90 transition-all flex items-center justify-center gap-4 shadow-2xl shadow-primary/10 transform active:scale-[0.98]"
                  >
